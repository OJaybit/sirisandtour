...
const itemVariants: Variants = {
  ...
  show: {
    ...
    transition: {
      duration: 0.45,
      ease: [0.16, 1, 0.3, 1], // same feel as Thank You
    },
  },
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-12 grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-2 gap-3">
            ...
            <motion.div
              ...
              className="relative lg:col-span-4 aspect-[4/3] overflow-hidden"
            >
              <Image
            ...
            <motion.div
              variants={itemVariants}
              className="relative lg:col-span-8 lg:aspect-[24.5/9] overflow-hidden"
            >
              <Image
            ...
            >
              <motion.p
                variants={itemVariants}
                className="text-sm tracking-widest text-[#0A7BBE] font-semibold uppercase lg:mt-15 mt-4"
              >
                Salford Resort
              </motion.p>
              ...
              >
                At Paradise Resort, we are committed to creating a sustainable
                future while providing an exceptional guest experience. Our
                sustainability practices focus on minimizing environmental
